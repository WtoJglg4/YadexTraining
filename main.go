...
// 		}
// 		fmt.Println(nums)
// 		res1, res2 := maxProduct1(nums)
// 		res3, res4 := maxProductSLOW(nums)
// 		res5, res6 := maxProduct(nums)
// 		fmt.Println(res1, res2, res3, res4, res5, res6, res1 == res3, res2 == res4, res3 == res5, res4 == res6)
// 		if res1 != res3 || res2 != res4 || res3 != res5 || res4 != res6 {
// 			return
// 		}
// 	}
...
// 	if pos == -1 {
// 		if neg == 1 {
// 			fmt.Println(min(maxPos, minNeg), max(maxPos, minNeg))
// 			return
// 		} else {
...
// // 	// 	kPerN = k2 / n2
// // 	// } else {
// // 	// 	kPerN = int(math.Round(float64(k2) / float64(n2)))
// // 	// }
// // 	kPerP = int(math.Round(float64(k2) / float64(p2)))
// // 	//fmt.Println(math.Round(float64(k2) / float64(n2)))
// // 	kPerN = kPerN * m
// // 	if k2 < p2*kPerP {
// // 		fmt.Println("-1 -1")
// // 		return
...
// // 		n1++
// // 	}
// // 	fmt.Println(kPerN, kPerP, k1, p1, n1)
// // }
